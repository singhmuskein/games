...
//type declaration
interface ILinearGradientModalContainer {
  children: any;
  stageStatus: string;
  stageButton?: string;
  onClick: () => void;
...
const renderYellowBlockButton = (
  ...
  props: ILinearGradientModalContainer
) => {
...
const renderRibbonColor = (props: ILinearGradientModalContainer) => {
...
const LinearGradientModalContainer = (props: ILinearGradientModalContainer) => {
  return (
    <div className='linear-gradient-container yellow-box-shadow'>
      <div className='linear-gradient-sub-container'>
        {/* <div
          style={{
...
export { LinearGradientModalContainer };
